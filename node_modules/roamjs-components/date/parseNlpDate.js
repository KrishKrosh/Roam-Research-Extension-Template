...
exports.addNlpDateParser = void 0;
        ...
        if (results.length >= 2) {
            ...
            if (/start of/i.test(modifier.text)) {
                ...
                if (/week/i.test(date.text)) {
                    const newDateObj = (0, startOfWeek_1.default)(dateObj);
                ...
                const dateObj = date.date();
                if (/week/i.test(date.text)) {
                    const newDateObj = (0, endOfWeek_1.default)(dateObj);
                    assignDay(date.start, newDateObj);
                }
                if (/month/i.test(date.text)) {
                ...
                if (ORDINAL_REGEX.test(modifier.text) &&
                    ...
                    if (/month/i.test(d.text)) {
                        ...
                        const startOfWeekDate = (0, startOfWeek_1.default)(startOfMonthDate);
                        ...
                        const startOfWeekDate = (0, startOfWeek_1.default)(startOfYearDate);
                        const dayOfWeekDate = (0, addDays_1.default)(startOfWeekDate, date.start.get("weekday") || 0);
...
const parseRoamDate = (s, ref) => customDateNlp.parseDate(s, ref) || new Date();
exports.default = parseRoamDate;
